...
import {StylesStyled} from "./components/markUp/Styles_styled";
      ...
      <div className={styles.body}>
        ...
        {windowSize < 700
          ...
          : <div className={styles.nav}>
            ...
            <StylesStyled.NavWrapper><NavLink
              to={'/page/protected'}>ProtectedPage</NavLink></StylesStyled.NavWrapper>
          </div>
        }
...
//     setTodolists(todolists.filter(el => el.todolistsId !== todolistsId))
